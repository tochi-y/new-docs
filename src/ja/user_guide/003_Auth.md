...
![before-after](./image/auth/before-after.png)
...
![Access owner's data](./image/auth/access_owner_data.png)
...
![Access other owner's data](./image/auth/access_other_data.png)
...
![Access other owner's data by token exchange](./image/auth/access_other_data_by_exchange.png)
...
![Refresh Access token]](./image/auth/refresh.png)
...
詳細は[アクセス制御モデル](./006_Access_Control.html)の項を参照してください。
...
![Authorization Code Flow](./image/auth/personium-authz-code-flow/personium-authz-code-flow.png)

ホームアプリを経由した場合次のフローを取ります。

![Authorization Code Flow on home app](./image/auth/personium-authz-code-flow-home-app/personium-authz-code-flow.png)
